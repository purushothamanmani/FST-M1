...
public class Activity5 {
    ...
    public void smsTest() {
        ...
        driver.findElement(AppiumBy.id("com.google.android.apps.messaging:id/recipient_text_view")).sendKeys("9014842678");
        ...
        // Assertion
        String messageTextSent = driver.findElement(AppiumBy.id("com.google.android.apps.messaging:id/conversation_snippet")).getText();
